...
public class Message implements Serializable {
    ...
    public String getHmacString() { //get HMAC value of the message as Base64 string
        return Base64.getEncoder().encodeToString(SHA.digest(this.toStringWithoutHmac()));
    }
    public boolean checkHmac() { //check if the newly generated HMAC equals to the saved one, integrity check
